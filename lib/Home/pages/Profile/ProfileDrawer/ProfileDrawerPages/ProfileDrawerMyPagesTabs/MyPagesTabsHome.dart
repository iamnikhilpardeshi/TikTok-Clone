...
class MyPagesTabsHome extends StatefulWidget {
  @override
  _MyPagesTabsHomeState createState() => _MyPagesTabsHomeState();
}

class _MyPagesTabsHomeState extends State<MyPagesTabsHome> {
  @override
