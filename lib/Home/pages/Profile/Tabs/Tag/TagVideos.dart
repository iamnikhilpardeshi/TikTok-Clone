import 'package:AlcaTiktok/Home/pages/Profile/Tabs/Tag/TagVideosList.dart';
...
class TagVideos extends StatelessWidget {
  const TagVideos({Key key}) : super(key: key);
  @override
...
class TagVideosCard extends StatefulWidget {
  @override
  _TagVideosCardState createState() => _TagVideosCardState();
}

class _TagVideosCardState extends State<TagVideosCard> {
