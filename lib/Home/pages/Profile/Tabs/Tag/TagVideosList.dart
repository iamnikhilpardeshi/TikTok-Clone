...
class TagVideosList extends StatelessWidget {
  const TagVideosList({Key key}) : super(key: key);
  @override
...
class TagVideosListCard extends StatefulWidget {
  @override
  _TagVideosListCardState createState() => _TagVideosListCardState();
}

class _TagVideosListCardState extends State<TagVideosListCard> {
