...
class UploadedVideosList extends StatelessWidget {
  const UploadedVideosList({Key key}) : super(key: key);
  @override
...
class UploadVideosListCard extends StatefulWidget {
  @override
  _UploadVideosListCardState createState() => _UploadVideosListCardState();
}

class _UploadVideosListCardState extends State<UploadVideosListCard> {
