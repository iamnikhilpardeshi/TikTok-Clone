import 'package:AlcaTiktok/Home/pages/Profile/Tabs/Liked/LikedVideosList.dart';
                      ...
                      child: GestureDetector(
                        onDoubleTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => LikedVideosList()));
                        },
                        child: Card(
                          child: LikedVideosCard(),
                        ),
                      ),
                    );
                  },
...
class LikedVideosCard extends StatefulWidget {
  @override
  _LikedVideosCardState createState() => _LikedVideosCardState();
}

class _LikedVideosCardState extends State<LikedVideosCard> {
