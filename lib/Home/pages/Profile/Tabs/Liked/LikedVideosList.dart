...
class LikedVideosList extends StatelessWidget {
  const LikedVideosList({Key key}) : super(key: key);
  @override
...
class LikedVideosListCard extends StatefulWidget {
  @override
  _LikedVideosListCardState createState() => _LikedVideosListCardState();
}

class _LikedVideosListCardState extends State<LikedVideosListCard> {
