...
class FollowingCardVideos extends StatefulWidget {
  @override
  _FollowingCardVideosState createState() => _FollowingCardVideosState();
}

class _FollowingCardVideosState extends State<FollowingCardVideos> {
